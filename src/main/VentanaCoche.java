...
public class VentanaCoche extends JPanel {
	...
	public VentanaCoche() {
		...
		btnAnterior.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				actual = CocheControlador.getControlador().findPrevious(actual);
				cargarActualEnPantalla();
			}
		});
		...
		btnSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				actual = CocheControlador.getControlador().findNext(actual);
				cargarActualEnPantalla();
			}
		});
		...
		btnUltimo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				actual = CocheControlador.getControlador().findLast();
				cargarActualEnPantalla();
			}
		});
		panel.add(btnUltimo);
		...
		this.actual = CocheControlador.getControlador().findFirst();
		cargarActualEnPantalla();
	...
	private void cargarDatosFabricantes() {
		List<Entidad> fabricantes = FabricanteControlador.getControlador().findAll();
		
		for (Entidad f : fabricantes) {
			this.jcbFabricante.addItem((Fabricante) f);
		}
	}
	...
	private void cargarActualDesdePantalla() {
		...
		//RAFAthis.actual.setFabricante(jcbFabricante.getText());
	}
	...
	private void guardar () {
		...
		if (this.actual.getId() != 0) { // Modificación
			CocheControlador.getControlador().modify(actual);
		}
		else { // Alta -  nuevo
