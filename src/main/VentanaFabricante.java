...
public class VentanaFabricante extends JPanel {
	...
	public VentanaFabricante() {
		super();
		initialize();
		this.actual = FabricanteControlador.getControlador().findFirst();
	...
	private void initialize() {
		...
		btnAnterior.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				actual = FabricanteControlador.getControlador().findPrevious(actual);
				cargarActualEnPantalla();
			}
		});
		...
		btnSiguiente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				actual = FabricanteControlador.getControlador().findNext(actual);
				cargarActualEnPantalla();
			}
		});
		...
		btnUltimo.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				actual = FabricanteControlador.getControlador().findLast();
				cargarActualEnPantalla();
			}
		});
		panel.add(btnUltimo);
	...
	private void guardar () {
		...
		FabricanteControlador.getControlador().modify(actual);
	}
